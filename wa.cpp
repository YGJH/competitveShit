...
#pragma GCC optimize(                                                          \
	"-bmi -bmi2 -popcnt -abm -lzcnt -tbm -mmmx -msse -msse2 -msse3 -mssse3 -msse4.1 -msse4.2 -mavx -mavx2 -mfma -mbmi -mbmi2 -mpopcnt -mabm -mlzcnt -mtbm -mmmx -msse -msse2 -msse3 -mssse3 -msse4.1 -msse4.2 -mavx -mavx2 -mfma -mbmi -mbmi2 -mpopcnt -mabm -mlzcnt -mtbm")
#pragma G++ optimize(3)
...
signed main() {
	...
	sort(all(penalty) , [&](auto &a , auto &b) {
		return a.second * b.first > b.second * a.first  || (a.second * b.first == b.second * a.first && a.id < b.id) ;
	});
	for(int i = 0 ; i < n ; i++) {
		write(penalty[i].id, ' ');
	}
